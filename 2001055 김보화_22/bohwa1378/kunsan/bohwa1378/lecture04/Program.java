...
import ksnu.bohwa1378.lecture10.*;
import ksnu.bohwa1378.lecture13.*;
...
public class Program {
	public void runFunctions() {
		...
		int member=login.logIn();
		
		do{
			printFunctionTypes();
			try {
        	    number=scanner.nextInt();
            	selectFunction(number,member);
        	}
	...
	public void printFunctionTypes(){
        ...
        System.out.println("0) 회원관리(Administrator로 로그인 시에만 동작)");
        ...
        System.out.println("11) 대학 구성원 관리 시스템(ArrayList)");
        System.out.println("-1) 종료");
        System.out.print("선택 : ");
    }
	
    public void selectFunction(int number, int member) {
        switch(number){
	        case 0:
	        	if (member==1) {
	        		System.out.println("회원관리 프로그램을 진행합니다.");
	        		System.out.println();
	        		Login test0 = new Login();
	        		test0.runProgram();
	        	}
	        	else if (member==0) {
	        		System.out.println("권한이 없어 접근할 수 없습니다.");
	        	}
	        	else {
            ...
            case 10:
            	...
            	break;
            case 11:
            	UnivManagementArrayList test11 = new UnivManagementArrayList();
            	test11.runProgram();
            	break;
            case -1:
            	break;
